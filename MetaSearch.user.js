...
bt.addSource("PTH", function () {
    var wcd = "https://passtheheadphones.me/ajax.php?action=browse&searchstr={query}";
...
bt.addSource("APR", function () {
    var wcd = "https://apollo.rip/ajax.php?action=browse&searchstr={query}";
    ...
    return {
        ...
        icon: "data:image/png;base64,"
    };
});
...
bt.addSource("Rutor", function () {
    var rutor = "http://main-rutor.org/search/";
    ...
    return {
        ...
        onParse: {
            ...
            link_prepend: "http://main-rutor.org",
            sel: [
